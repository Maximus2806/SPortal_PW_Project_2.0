...
test.describe('[API] [Customers] [Create New Customer]', async function () {
  ...
  test('Should create new customer with random valid data and all fields', async function ({ customersApiService }) {
  ...
  test('Should create new customer with random valid data and only required fields', async function ({
    customersApiService
  }) {
